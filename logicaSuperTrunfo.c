...
int main() {
    ...
    // Menu para escolha do 1o item à ser comparado

    printf("Escolha o 1o item das cartas que você quer comparar:\n");
    printf("1 - População\n");
    printf("2 - Área\n");
    printf("3 - PIB\n");
    ...
    // Apresentação do comparação de acordo com a 1a escolha

    switch (opcao01) {
        case 1:
            printf("Veja quem ganhou na comparação da População: \n");
            printf("Área Carta 01 - %s: %d\n", nome_pais01, populacao01);
            printf("Área Carta 02 - %s: %d\n", nome_pais02, populacao02);
    ...
    printf("Escolha o 2o item das cartas que você quer comparar:\n");
    opcao01 != 1 ? printf("1 - População\n"): opcao01;
    opcao01 != 2 ? printf("2 - Área\n"):opcao01;
    opcao01 != 3 ? printf("3 - PIB\n"):opcao01;
    opcao01 != 4 ? printf("4 - Pontos Turísticos\n"):opcao01;
    opcao01 != 5 ? printf("5 - Densidade Demografica\n"):opcao01;
    printf("Opção 2...:");
    scanf("%d", &opcao02);
